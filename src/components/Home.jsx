...
const App = () => {
  ...
  const [newOrder, setNewOrder] = useState({ name: '', deliveryType: '' });
  ...
  const handleAddOrder = () => {
    if (newOrder.name && newOrder.deliveryType) {
      const updatedOrders = [...orders, { ...newOrder, id: orders.length + 1 }];
      setOrders(updatedOrders);
      setNewOrder({ name: '', deliveryType: '' });
    }
  };
  ...
  return (
    <div>
      <h1 className='text-2xl mt-3 font-mono text-transparent bg-clip-text bg-gradient-to-r from-gray-400 to-neutral-500'>Anti Blue Ray Glasses Orders</h1>
     
      <div className="add-order mt-4  mx-auto">
        <div class="flex flex-col justify-center items-center gap-3 -mx-3 mb-2">
          ...
          <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0 ">
            ...
            <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 " placeholder="Customer Name"
              type="text"
              id="name"
              name="name"
              value={newOrder.name}
          ...
          <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0 ">
            ...
            <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 " placeholder="Product Name"
              type="text"
              id="name"
              name="name"
              value={newOrder.name}
        ...
        <button onClick={handleAddOrder} className='p-3 text-white rounded-lg w-1/4 mb-4 mt-2 bg-[radial-gradient(ellipse_at_top_left,_var(--tw-gradient-stops))] from-gray-400 via-neutral-500 to-zinc-400'>Add Order</button>
      </div>
      <div className="tabs flex flex-row gap-5 justify-center mt-4 mb-6 text-xl text-slate-600">
        <button
